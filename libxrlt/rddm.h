...
xrltJSON2XMLPtr xrltJSON2XMLInit(xmlNodePtr insert);
xrltBool xrltJSON2XMLFree(xrltJSON2XMLPtr json2xml);
xrltBool xrltJSON2XMLFeed(xrltJSON2XMLPtr json2xml, xmlChar *chunk, size_t l);
xmlChar *xrltJSON2XMLGetError(xrltJSON2XMLPtr json2xml, xmlChar *chunk, size_t l);
