// This is a copy of node.cc with no Start function and with the
// implementation of several functions from iojswrap.h to run
// io.js as a library from C applications.
#include "node.h"
#include "iojswrap.h"
